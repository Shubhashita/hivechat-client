...
const Authentication = () => {
    ...
    const buttonClasses =
        `w-full text-white bg-backgroundColor hover:bg-[#0c3837] focus:ring-4 focus:outline-none 
    ...
    return (
        <div
            className={`relative w-full bg-white min-h-screen overflow-hidden
                ...
                before:transition-all before:duration-[2s] lg:before:duration-[1.8s]  ${isSignUpMode
            ...
            <div className="absolute w-full h-full top-0 left-0">
                <div
                    className={` absolute top-[95%] lg:top-1/2 left-1/2 grid grid-cols-1 z-[5] -translate-x-1/2 
                        ...
                        lg:duration-[0.7s] ease-[ease-in-out] "  ${isSignUpMode
            ...
            <div className="absolute h-full w-full top-0 left-0 grid grid-cols-1   max-lg:grid-rows-[1fr_2fr_1fr]  
                ...
                >
                    <div
                        ...
                        delay-[0.8s] lg:delay-[0.4s]   max-lg:pr-[15%]  max-md:px-4  max-md:py-2 ${isSignUpMode
                    ...
                    >
                        <div className="flex items-center justify-center gap-2 mb-2">
                            <img
                                ...
                                style={{ filter: "brightness(0) saturate(100%) invert(57%) sepia(91%) saturate(347%) hue-rotate(124deg) brightness(91%) contrast(85%)" }}
                            />
                            <h3 className="font-semibold leading-none text-[1.2rem] lg:text-[2rem] text-[#10b5b0]">
                                HiveChat
                            </h3>
                        </div>
                ...
                >
                    <div
                        ...
                        lg:delay-[0.4s]   max-lg:pr-[15%] max-md:px-4  max-md:py-2 ${isSignUpMode
                                ? ""
                                : "lg:translate-x-[800px]   max-lg:translate-y-[300px]"
                            }`}
                    >
